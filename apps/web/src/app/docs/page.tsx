    ...
    <main className='shell section-tight'>
      <header className='max-w-3xl'>
        ...
        <p className='mt-7 text-base leading-relaxed text-fg-muted'>
          VibeGuard scans a repository with several independent security tools,
          normalises their findings, and turns the results into one report with
          a score and actionable explanations. These pages describe how that
          works end to end — including what happens when part of it fails, and
        ...
        {DOC_SECTIONS.map((section, index) => (
          <li key={section.slug}>
            ...
            >
              ...
              <h2 className='mt-3 display-heading text-lg text-fg'>
                {section.title}
              </h2>
