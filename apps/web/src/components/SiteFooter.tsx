      ...
      <div className='shell py-16'>
        <div className='grid gap-12 lg:grid-cols-[minmax(0,1.4fr)_repeat(3,minmax(0,1fr))]'>
          <div className='max-w-sm'>
            ...
            <p className='mt-4 text-sm leading-relaxed text-fg-muted'>
              A security and quality gate for AI-generated apps. Real scanners,
              a deterministic score, and an LLM that explains findings rather
              than inventing them.
            </p>
          </div>
            ...
            <ul className='grid gap-2'>
              {SERVICES.map((service) => (
                ...
                >
                  <span
                    aria-hidden
                    className={`h-2 w-2 shrink-0 ${service.accent}`}
                  />
        ...
        <div className='mt-14 flex flex-wrap items-center gap-x-6 gap-y-3 border-t-2 border-line pt-6 text-xs text-fg-muted'>
          ...
          <span className='ml-auto'>
            Build for the Zerops Challenge. MIT licensed.
          </span>
        </div>
      </div>
    </footer>
